...
!-------------------------------------------------------------------------------
   ...
   !------------------------------------------------------------------------
      ...
      INTEGER(INTK) :: l,m,j,k, a,b, p,q, pp,qq, lm_min,lm_max
      ...
      jloop: DO j = 0, JMAX
         ...
         kloop1: DO k = 0, j
            ...
            lloop1: DO l = (j+1), LMAX
               ...
               ! (m-k) terms
               phase = 1 
               DO m = (k-1), MAX((k-a),0_intk), -1     ! reverse order 
                  ! (m-k)<0
                  phase = -phase 
                  b = -(m-k)
...
subroutine pbc_restore_W_matrix(lmax,W_NF)
  ...
  integer(intk) :: l,j,row_min,row_max,col_min,col_max
