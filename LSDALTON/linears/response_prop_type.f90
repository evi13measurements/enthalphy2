...
Contains
  ...
  subroutine mcdinputitem_set_default_config(MCDinput)
    ...
    !because it is 0.005D0 for lorentz
    !and 0.0070851079363103793d0 for gaussian
  ...
  subroutine RSPSOLVERiputitem_set_default_config(rspsolverinput)
    ...
    rspsolverinput%rsp_conv_factor = 1.0d-3
    rspsolverinput%rsp_dyn_thresh = 1d-4
    ...
    rspsolverinput%rsp_conv_thr = 1.0d-8
    rspsolverinput%rsp_ovlmin = 1.d-5
    rspsolverinput%rsp_thr_lin_depend = 1.d-20
    rspsolverinput%rsp_thr_round = 1.d-10
    rspsolverinput%rsp_t1min = 1.d-8
    rspsolverinput%rsp_tolerance = 1.0d-7 
