...
use precision
IMPLICIT NONE
REAL(REALK), PARAMETER  :: D0 = 0D0, D1 = 1D0,D2 = 2D0, D3 = 3D0
!REAL, PARAMETER  :: D0 = 0D0, D1 = 1D0,D2 = 2D0, D3 = 3D0
INTEGER     :: NHTYP
...
REAL(REALK) :: AH,H,EPH,RL,RH,AL,HTMP,RHTMP,GRDC,DUMMY,DISERR90,OUTERR90
...
IF(NR.GT.NRADPT) CALL LSQUIT('Too many radial points.')
RADNDE(NR) = RL
...
REAL(REALK), PARAMETER  :: ACC=1.0D-5
REAL(REALK), PARAMETER  :: D0=0.0D0,D1=1.0D0,D2=2.0D0,TI=1.0D1
REAL(REALK), PARAMETER  :: PI = 3.141592653589793D00
!REAL, PARAMETER  :: ACC=1.0D-5
!REAL, PARAMETER  :: D0=0.0D0,D1=1.0D0,D2=2.0D0,TI=1.0D1
!REAL, PARAMETER  :: PI = 3.141592653589793D00
INTEGER, PARAMETER      :: MXIT=20
REAL(REALK)             :: CF(4,0:4)
REAL(REALK)             :: FAC,RDOG,DISERR90,HTLOG,PIH,PIHL
REAL(REALK)             :: PIEX,U0,U1,F0,F1,DX,RD,RDLOG,POLVAL90
!REAL             :: CF(4,0:4)
!REAL             :: FAC,RDOG,DISERR90,HTLOG,PIH,PIHL
!REAL             :: PIEX,U0,U1,F0,F1,DX,RD,RDLOG,POLVAL90
INTEGER           :: IFAC,I,LM,IT,L
CF(1,0) = 0.91570D0
CF(2,0) = 0.78806D-1
CF(3,0) = 0.28056D-2
CF(4,0) = 3.4197D-05
...
!      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
REAL(REALK),PARAMETER  :: ACC=1.0D-6
REAL(REALK),PARAMETER  :: D0=0.0D0,D1=1.0D0,D2=2.0D0,TI=1.0D1
REAL(REALK),PARAMETER  :: PI = 3.141592653589793D00
!REAL,PARAMETER  :: ACC=1.0D-6
!REAL,PARAMETER  :: D0=0.0D0,D1=1.0D0,D2=2.0D0,TI=1.0D1
!REAL,PARAMETER  :: PI = 3.141592653589793D00
INTEGER,PARAMETER      :: MXIT=8
REAL(REALK)            :: TOLEN,FAC,EXPL,A,ALN,RLN,U,F0HLN
REAL(REALK)            :: F1HLN,DX,OUTERR90,AL,RD
...
!!$      IF(ABS(PRICCF(IAOS,NUMCFA)).GT.0D0) THEN !WARNING
