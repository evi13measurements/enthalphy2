...
/* INTERFACE PART */
static integer  lda_read(const char* conf_line, double *hfweight);
...
static integer  ldagauss_read(const char* conf_line, double *hfweight);
static integer  blyp_read(const char* conf_line, double *hfweight);
static integer  b3lyp_read(const char* conf_line, double *hfweight);
static integer  b3lypgauss_read(const char* conf_line, double *hfweight);
static integer  bp86_read(const char* conf_line, double *hfweight);
static integer  bpw91_read(const char* conf_line, double *hfweight);
static integer  b3p86_read(const char* conf_line, double *hfweight);
static integer  b3p86g_read(const char* conf_line, double *hfweight);
static integer  kt1_read(const char* conf_line, double *hfweight);
static integer  kt2_read(const char* conf_line, double *hfweight);
static integer  kt3_read(const char* conf_line, double *hfweight);
static integer  olyp_read(const char* conf_line, double *hfweight);
static integer  pbe_read(const char* conf_line, double *hfweight);
static integer  pbe0_read(const char* conf_line, double *hfweight);

static integer  gga_isgga(void);
static integer  xalpha_read(const char* conf_line, double *hfweight);
static integer  gga_key_read(const char* conf_line, double *hfweight);
...
static integer
xalpha_read(const char* conf_line, double *hfweight)
{
    float weight;
...
static integer
lda_read(const char* conf_line, double *hfweight)
{
    return 1;
}
...
static integer
ldagauss_read(const char* conf_line, double *hfweight)
{
...
static integer
blyp_read(const char* conf_line, double *hfweight)
{
    gga_fun_list = add_functional(gga_fun_list, &SlaterFunctional, 1.0);
...
static integer
b3lyp_read(const char* conf_line, double *hfweight)
{
...
static integer
b3lypgauss_read(const char* conf_line, double *hfweight)
{
    static const real lypw = 0.81, dirw = 0.8;
    gga_fun_list = add_functional(gga_fun_list, &SlaterFunctional,  dirw);
    gga_fun_list = add_functional(gga_fun_list, &BeckeFunctional,  0.72);
...
static integer
bp86_read(const char* conf_line, double *hfweight)
{
    gga_fun_list = add_functional(gga_fun_list, &SlaterFunctional, 1.0);
    gga_fun_list = add_functional(gga_fun_list, &BeckeFunctional, 1.0);
...
static integer
b3p86_read(const char* conf_line, double *hfweight)
{
    static const real lypw = 0.81, dirw = 0.8;
    gga_fun_list = add_functional(gga_fun_list, &SlaterFunctional,  dirw);
    gga_fun_list = add_functional(gga_fun_list, &BeckeFunctional,  0.72);
...
static integer
b3p86g_read(const char* conf_line, double *hfweight)
{
    static const real lypw = 0.81, dirw = 0.8;
    gga_fun_list = add_functional(gga_fun_list, &SlaterFunctional,  dirw);
    gga_fun_list = add_functional(gga_fun_list, &BeckeFunctional,  0.72);
...
static integer
bpw91_read(const char* conf_line, double *hfweight)
{
...
static integer
kt1_read(const char* conf_line, double *hfweight)
{
...
static integer
kt2_read(const char* conf_line, double *hfweight)
{   
...
static integer
kt3_read(const char* conf_line, double *hfweight)
{
...
static integer
olyp_read(const char* conf_line, double *hfweight)
{
...
static integer
pbe_read(const char* conf_line, double *hfweight)
{
...
static integer
pbe0_read(const char* conf_line, double *hfweight)
{
    gga_fun_list = add_functional(gga_fun_list, &PBEcFunctional, 1.0);
...
*/
static integer
gga_key_read(const char* conf_line, double *hfweight)
{
    integer res = 1, i;
    float f;
