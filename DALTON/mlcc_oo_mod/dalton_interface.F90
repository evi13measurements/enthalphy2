   subroutine get_cholesky_vectors(chol,mo_coef,n_occ,n_vir)
!
...
!
      ...
      call allocator(chol_mo_sq,chol%n_mo,chol%n_mo)
!
      chol_ao    = zero
      chol_ao_sq = zero
      chol_mo_sq = zero
...
!
      call allocator(X,chol%n_ao,chol%n_mo)
!
      X = zero
!
!     Calculate the number of molecular orbitals
!
      n_mo = n_occ + n_vir
!
