...
!
   ...
   real(dp), dimension(:,:), allocatable      :: cho_diag      
   real(dp), dimension(:,:), allocatable      :: cho_ao        
   integer       :: lencho
   real(dp), dimension(:,:), allocatable      :: cholesky_ao,cholesky_ao_sq    
   real(dp), dimension(:,:), allocatable      :: cholesky_mo_sq,cholesky_mo,X
!
...
!
   call allocator_n(cholesky_ao,n_twoel_diag,1)
   call allocator_n(cholesky_ao_sq,n_basis,n_basis)
   call allocator_n(X,n_basis,n_orbitals)
   call allocator_n(cholesky_mo_sq,n_orbitals,n_orbitals)
!
   cholesky_ao = zero
   cholesky_ao_sq = zero
   cholesky_mo_sq = zero
...
!  Deallocation
!
   call deallocator_n(cholesky_ao,n_twoel_diag,1)
   call deallocator_n(cholesky_ao,n_basis,n_basis)
   call deallocator_int(index_reduced,n_reduced,1)
   call deallocator_n(cholesky_mo_sq,n_orbitals,n_orbitals)
