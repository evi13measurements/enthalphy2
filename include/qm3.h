...
C     ----------------------------------------------
C
      REAL*8   QM3CHG,QM3LJA,QM3LJB,ALPIMM,CHAOLD
      REAL*8   ALTXX,ALTXY,ALTXZ,ALTYY,ALTYZ,ALTZZ
      REAL*8   THDISC,ECLPOL,ECLVDW,ECLQM3,ENUQM3
      REAL*8   EMMPOL,EMMVDW,EMMELC,EMM_MM,EVDWSH
      REAL*8   PEDIP1,ENSQM3,EPOQM3,QMCOM,ADAMP
     ...
     *                OLDTG,ONLYOV,LONUPO,LOELFD,LOSPC,LOEC3,
